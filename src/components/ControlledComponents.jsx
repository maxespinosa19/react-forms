...
export default function ControlledComponents() {
    ...
    return (
        ...
        <label htmlFor="firstName">First Name:</label><input name ="firstName"type="text" onChange={e => setFirstName(e.target.value)} />
        <label htmlFor="lastName">Last Name:</label><input name ="firstName"type="text" onChange={e => setLastName(e.target.value)} />
        </>
    )
}